...
public class bankSystem {
    ...
    public static void transferProcess(ArrayList<bankSystem>accounts, int enterAccNum, int receiversNum, double withdrawAmount){
        for(bankSystem b : accounts){
            if(b.account_number == enterAccNum){
                b.starting_balance = b.starting_balance - withdrawAmount;
            }
        ...
        for(bankSystem b : accounts){
            if(b.account_number == receiversNum){
                b.starting_balance = b.starting_balance + withdrawAmount;
            }
        }
